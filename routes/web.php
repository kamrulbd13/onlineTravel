...
Route::get('visa-guide',[HomeController::class,'visaGuide'])->name('visa-guide');
Route::post('search-visa',[HomeController::class,'searchVisa'])->name('search-visa');
...
Route::get('/package-view/{id}',[HomeController::class,'PackageView'])->name('package-view');
...
Route::post('flight-post', [HomeController::class, 'flightPost'])->name('flight-post');




Route::post('/book-now/{id}', [BookingController::class, 'book'])->name('book-now');
...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::delete('contact-delete/{id}', [AdminDashboardController::class, 'contactDelete'])->name('contact-delete');
    ...
    Route::get('add-visa',[FaqController::class,'addVisa'])->name('add-visa');
    Route::post('post-visa',[FaqController::class,'postVisa'])->name('post-visa');
    Route::get('all-visa',[FaqController::class,'allVisa'])->name('all-visa');
    Route::delete('delete-visa/{id}',[FaqController::class,'deleteVisa'])->name('delete-visa');
