            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <!--add tour icon with the class side-menu__icon-->
                        <span class="side-menu__icon"><i class="fa fa-question"></i></span>
                        <span class="side-menu__label">Visa Guide</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                       
                        <li><a href="{{route('add-visa')}}" class="slide-item">Add-Visa</a></li>
                        <li><a href="{{route('all-visa')}}" class="slide-item">All-Visa</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
