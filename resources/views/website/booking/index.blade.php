...
<section class="booking-form">
    ...
    font-family: 'Poppins';
    margin: 20px 0px;">Booking Form</h1>
    <p style="text-align: center;
    font-family: 'Poppins';">Please fill all the information carefully.</p>
                 <form action="{{route('new-booking-order', ['id' => $id])}}" method="POST">
                            ...
                            <div class="row mb-3">
                              <label class="col-md-3">Approx Visiting date</label>
                              <div class="col-md-9">
                                  <input type="date" class="form-control" required name="v_date"/>
                                  <span class="text-danger">{{$errors->has('v_date') ? $errors->first('v_date') : ''}}</span>
                              </div>
                          </div>
                           <div class="row mb-3">
                                <div class="col-md-9">
