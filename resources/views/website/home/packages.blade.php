...
<html lang="en">
  ...
  <section class="pakeg-view">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-10 pakeg-sorting">
            <ul class="nav nav-pills" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">ALL (NEW - OLD)</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="bi bi-sort-down"></i> PRICE HEIGH TO LOW</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false"> <i class="bi bi-sort-up"></i></i> PRICE LOW TO HEIGH </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-disabled-tab" data-bs-toggle="pill" data-bs-target="#pills-disabled" type="button" role="tab" aria-controls="pills-disabled" aria-selected="false"><i class="bi bi-sort-alpha-down"></i> ALL (A - Z)</button>
              </li>
            </ul>
          </div>
        <div class="col-md-1"></div>
        ...
        <div class="col-md-1"></div>
        <div class="col-md-3 all-project">
          <form action="{{ route('website.package.search') }}" method="GET" >
            @csrf
          <div class="project-details-search">
            <p>Search for a Tour</p>
            <div class="d-flex" role="search">
              <input class="form-control" type="search" name="title" placeholder="search by trip name" aria-label="Search">
              <button class="btn btn-outline-success" type="submit"><i class="bi bi-search"></i></button>
            </div>


          <div class="input-price" style="margin-top: 25px;">
          ...
          <div class="btn-rest">
            <a href="{{route('website.package')}}"> <button type="button" class="btn btn-warning">RESET</button></a>
           </div>
        </div>
        </form>
        </div>

        <div class="col-md-7 all-project">
