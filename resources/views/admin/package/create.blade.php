            ...
            <div class="card-body">
                ...
                <form action="{{route('package.save')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="border-warning form-control" id="tourTitle" name="tour_title" placeholder="Enter your Tour Title" type="text" required value="{{ old('tour_title') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="border-warning form-control" id="tourRating" name="tour_rating" placeholder="Enter your Tour Rating" type="text" required value="{{ old('tour_rating') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <textarea class="border-warning form-control" id="tourAddress" name="tour_address" placeholder="Enter Tour Address" required value="{{ old('tour_address') }}"></textarea>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <select class="form-control border-warning select2-show-search form-select" data-placeholder="Choose one" name="package_category_id" required value="{{ old('package_category_id') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                             <select class="form-control select2-show-search form-select border-warning" data-placeholder="Choose one" name="place_id" required value="{{ old('place_id') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control border-warning" name="tour_start_date" id="startDate" placeholder="DD/MM/YY" type="date" required value="{{ old('tour_start_date') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control border-warning" name="tour_end_date" id="endDate" placeholder="DD/MM/YY" type="date" required value="{{ old('tour_end_date') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="border-warning form-control file-input" type="file" id="packageFile" name="package_image" required value="{{ old('package_image') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="border-warning form-control file-input" type="file" id="formFile" name="other_image[]" required value="{{ old('other_image[]') }}" multiple/>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <table class="table table-bordered col-md-9">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control select2-show-search form-select" data-placeholder="Choose one" name="price[0][hotel_type]" required value="{{ old('price[0][hotel_type]') }}">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea name="overview" id="note1" cols="30" rows="4" placeholder="Type Here" required value="{{ old('overview') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                     <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea name="meeting_pickup" id="note2" cols="30" rows="4" placeholder="Type Here" required value="{{ old('meeting_pickup') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                     <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h3 class="card-title">Hotels Overview</h3>
                                </div>
                                <div class="card-body">
                                    <textarea name="included_excluded" id="note3" cols="30" rows="4" placeholder="Type Here" required value="{{ old('included_excluded') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                     <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea name="expectations" id="note4" cols="30" rows="4" placeholder="Type Here" required value="{{ old('expectations') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                     <div class="row mb-4">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <textarea name="terms_conditions" id="note5" cols="30" rows="4" placeholder="Type Here" required value="{{ old('terms_conditions') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
